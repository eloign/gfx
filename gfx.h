...
void gfx_fill_triangle(int, int, int, int, int, int);

void gfx_fill_arc(int, int, unsigned int, unsigned int, int, int);

void gfx_fill_segment(int, int, unsigned int, int, int);
