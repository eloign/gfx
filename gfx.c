...
void gfx_arc(int x, int y, unsigned int width, unsigned int height, int start_angle, int end_angle) {
  XDrawArc(gfx_display, gfx_window, gfx_gc, x, y, width, height, start_angle*64, end_angle*64);
}

void gfx_segment(int x, int y, unsigned int radius, int start, int end) {
  gfx_arc(x, y, radius, radius, start, end);
}
...
void gfx_fill_arc(int x, int y, unsigned int width, unsigned int heigth, int start, int end) {
  XFillArc(gfx_display, gfx_window, gfx_gc, x, y, width, heigth, start*64, end*64);
}

void gfx_fill_segment(int x, int y, unsigned radius, int start, int end) {
  gfx_fill_arc(x, y, radius, radius, start, end);
}
